...
<head>
    <meta charset="UTF-8">
    <title>Développement Web - H4 P2021 - Bruno Simon</title>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">h4 P2021 - Dév<span class="hidden-xs">eloppement</span> Web</a>
            <ul class="nav navbar-nav navbar-right">
                <li><a class="btn btn-light" href="https://github.com/brunosimon/hetic-h4-p2021" target="_blank">GitHub</a></li>
            </ul>
        </div>
    </nav>
